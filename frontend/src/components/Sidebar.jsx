function Sidebar({
    lucroMinimo, setLucroMinimo,
    symbolFiltro, setSymbolFiltro,
    ...
    return (
      <div className={`p-3 ${darkMode ? 'bg-dark text-light' : 'bg-light'}`} style={{ minWidth: 260, height: '100vh' }}>
        ...
        />
        <select className="form-select mb-3" value={intervalo} onChange={(e) => setIntervalo(Number(e.target.value))}>
        ...
        <button className="btn btn-outline-dark w-100" onClick={toggleDark}>
